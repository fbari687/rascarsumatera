...
@section('content')
<div class="col-md-4">
  <button type="button" class="btn btn-block btn-success mb-3 mx-4" data-bs-toggle="modal" data-bs-target="#modal-form"><i class="fa-solid fa-plus"></i> Tambah Jenis Baru</button>
        ...
        <div class="modal-body p-0">
          <div class="card card-plain">
            <div class="card-header pb-0 text-left">
              <h5 class="">Tambah Jenis Baru</h5>
              <p class="mb-0">Masukkan Jenis Baru</p>
            </div>
            <div class="card-body">
              <form role="form text-left" action="/admin/dashboard/type" method="POST">
                @csrf
    ...
    <table class="table table-striped align-items-center mb-0">
      ...
      <tbody>
        ...
        <tr class="border-bottom">
          ...
          <td>
            <a href="/admin/dashboard/type/{{ $type->slug }}/edit" class="btn btn-info mt-3"><i class="fa-solid fa-pen-to-square"></i></a>
            <button type="button" class="btn bg-gradient-danger mt-3" data-bs-toggle="modal" data-bs-target="#{{ $type->slug }}">
              <i class="fa-solid fa-trash"></i>
            </button>
            <div class="modal fade" id="{{ $type->slug }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    Anda ingin menghapus Jenis <strong>{{ $type->name }}</strong> ?
                  </div>
                  <form action="/admin/dashboard/type/{{ $type->slug }}" method="POST" class="modal-footer">
                    @csrf
                    @method('delete')
