...
<head>
  ...
  <title>Login RASCARSUMATERA</title>
  @vite('resources/css/app.css')
  @vite('resources/js/app.js')
</head>
<body>
  <div style="background-image: url('{{ asset('img/Hero RascaR.png') }}')" class="flex h-screen items-center py-16">
            ...
            <form action="/admin" method="POST">
              ...
              <div class="grid gap-y-4">
                ...
                <div>
                  ...
                  <p class="hidden text-xs text-red-600 mt-2" id="password-error">{{ session('failed') }}</p>
                  @endif
                </div>
                <!-- End Form Group -->
